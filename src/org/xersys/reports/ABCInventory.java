...
public class ABCInventory implements XReport{
    private final String REPORTID = "230001";
    ...
    private String getReportSQL(){
        return "SELECT" +
                ...
                " WHERE a.sStockIDx = b.sStockIDx" +
                    ...
                    " AND a.cRecdStat = '1'" +
                    " AND a.cClassify IN ('A', 'B', 'C')" +
                " ORDER BY a.cClassify, a.nAvgMonSl DESC, c.sDescript, b.sBarCodex, b.sDescript";
    }
