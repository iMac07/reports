...
public class DateCriteriaController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        p_sDateThru = SQLUtil.dateFormat(p_oNautilus.getServerDate(), SQLUtil.FORMAT_SHORT_DATE);
        
        dateFrom.setValue(LocalDate.now());
        dateThru.setValue(LocalDate.now());
    }    
    ...
    private void dateThru_OnAction(ActionEvent event) {
        p_sDateThru = dateThru.valueProperty().getValue().toString();
    }
    ...
    public String getDateThru(){return p_sDateThru;}
